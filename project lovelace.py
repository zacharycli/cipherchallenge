...
def meansquare(string):
    ...
    for i in string:
        if i in freq.keys():
            freq[i] += 1
    for i in freq.keys():
        squared_error += abs((freq[i]/total)*1_000-stdfreq[i])
...
def meandigram(string):
    ...
    for k in range(total):
        ...
        if i in freq.keys():
            freq[i] += 1
    for i in freq.keys():
        squared_error += abs((freq[i]/total)*1_000-digrams[i])
    return squared_error
...
def meantrigram(string):
    ...
    for k in range(total):
        ...
        if i in freq.keys():
            freq[i] += 1
    for i in freq.keys():
        squared_error += abs((freq[i]/total)*1_000-trigrams[i])
    return squared_error
#print(ret)
overall = 0
total = 0
